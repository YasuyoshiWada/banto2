        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('item.edit.index')}}"><i class="fi fi-sr-edit" style="margin-right: 5px;"></i>Edit item</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('categoryitem.categoryitemlist')}}"><i class="fi fi-sr-home" style="margin-right: 5px;"></i>Categories</a>
                    </li>
                    <li class="nav-item">
